        ...
        {!uploading && !completed ? (
          <>
            <div
              ...
              className="border-2 border-dashed border-gray-200 hover:border-gray-400 bg-gray-50/50 rounded-xl p-8 text-center cursor-pointer transition-colors flex flex-col items-center justify-center"
            >
              <UploadCloud className="w-10 h-10 text-gray-400 mb-3 stroke-[1.5]" />
            ...
            {selectedFiles.length > 0 && (
              <div className="space-y-2 max-h-40 overflow-y-auto pr-1">
                <p className="text-xs font-semibold text-gray-500 uppercase">Selected files:</p>
            ...
            <div className="flex items-center justify-end gap-2 pt-2">
              ...
              <button
                ...
                className="px-4 py-2 text-xs font-medium text-white bg-zinc-900 hover:bg-zinc-800 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg transition-colors cursor-pointer"
              >
          ...
          <div className="py-8 text-center space-y-4">
            <p className="text-sm font-medium text-gray-800">Uploading to Supabase Storage...</p>
          ...
          <div className="py-8 text-center space-y-3">
            ...
            <p className="text-xs text-gray-500">File(s) added to your Drive.</p>
          </div>
        )}
      </div>
    </Modal>
